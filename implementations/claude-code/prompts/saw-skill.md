...
8a. **E25/E26/E35: Integration gap detection.** After finalization succeeds, read `references/failure-routing.md` § E25/E26/E35 for integration validation and wiring flow.
