...
2. **Integration wave check (E27):** If the current wave has `type: integration` in the manifest, this is a wiring-only wave. Skip worktree creation and isolation verification. For each agent in the wave:
