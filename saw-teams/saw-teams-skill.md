...
enforcement; the number is the anchor for cross-referencing and audit. E20–E22 are orchestrator-only rules (stub detection, quality gates, scaffold build verification).*
