...
| [execution-rules.md](execution-rules.md) | Defines fifteen execution rules (E1–E15) governing state transitions, agent launches, completion handling, merge procedures, verification gates, and IMPL doc lifecycle |
